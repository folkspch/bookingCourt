<template>
  <div>
    <v-row>
      <v-col cols="16" lg="">
        <v-row no-gutters class="d-flex">
          <label for="selectedDateA" class="input-label"
            >เลือกวันที่ต้องการ</label
          >
          <!-- Add this label -->
          <v-col cols="" lg="">
            <input
      ...
      <v-col cols="8" lg="">
        <v-row no-gutters class="d-flex">
          <v-col cols="4" lg="">
            <v-btn @click="API()">Get Data</v-btn>
          </v-col>
          <v-col cols="4" lg="">
    ...
    <v-simple-table class="mb-5 custom-table" style="paddingtop: 30px">
      <template v-slot:default>
        ...
        <tbody>
          ...
          >
            <td class="body-cell">
              <v-row>
                <p class="ml-2">{{ item.court_code }}</p>
              </v-row>
            </td>
            <td class="body-cell">
              <v-row>
...
export default {
  ...
  methods: {
    ...
    method: "GET",
    params: {
      date: this.selectedDateA ? this.selectedDateA : null, // Pass the selected date as a query parameter
    },
  };
